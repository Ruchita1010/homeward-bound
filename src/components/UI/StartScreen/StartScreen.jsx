...
const StartScreen = ({ setShowStartScreen }) => {
  ...
  const credits = `
    "Shiny Forest" (https://skfb.ly/6yCLo) by Whitend is licensed under Creative Commons Attribution (http://creativecommons.org/licenses/by/4.0/)
  ...
  const about = `
    Embark on a Homeward Bound Journey!

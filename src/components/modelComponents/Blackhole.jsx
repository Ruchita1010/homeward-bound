...
Command: npx gltfjsx@6.1.4 ../../assets/3d-models/Blackhole.glb -T
...
import BlackholeModel from '../../assets/3d-models/Blackhole.glb';

const Blackhole = (props) => {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(BlackholeModel);
